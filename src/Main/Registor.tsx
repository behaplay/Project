export const Registor = () => {
    return (
        <section className="bg-siniy py-[80px] flex flex-col lg:flex-row justify-center items-center gap-10 mt-32 m-auto">
            <div className="text-center text-white bg-siniy w-[75%] lg:w-[348px] h-[10%] lg:h-[270px] p-[20px] lg:py-[48px] lg:px-[28.800px] border-[1.600px] border-aran rounded-2xl">
            ...
            <div>
                ...
                <div className="W-[100%] md:w-[728px] flex flex-col gap-6">
                    ...
                    <div className="flex flex-row gap-6">
                        ...
                        <button className="wek w-[100%] md:w-[332px] h-[45.2px] font-semibold text-[14px] bg-aran border-[1px] border-aran rounded-sm active:bg-[white] active:text-[black] active:border-[1px] active:border-black">Submit</button>
                    </div>
                </div>
            </div>
        </section>
