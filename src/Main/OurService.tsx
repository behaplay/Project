export const OurService = () => {
    return (
        <section className="m-auto mt-20 px-5 sm:px-20 md:px-24 pb-5 lg:px-[205px] bg-gray-100">
            <div className="flex flex-col justify-center items-center py-24">
                <h5 className="text-[38px] font-bold">Our Service</h5>
                <hr className="w-[67px] h-[6px] bg-siniy rounded-lg" />
            </div>
            <div className="flex flex-col justify-center bg-white rounded-3xl w-[100%]">
                ...
                <div className="flex flex-col lg:flex-row lg:items-center gap-12">
                    ...
                    <div className="flex flex-col text-center sm:text-start items-center sm:items-start mx-10 mb-5 gap-6 lg:w-[380px]">
                        <h5 className="text-[21px] font-bold text-center lg:text-start">Business Consulting</h5>
                        <p className="text-[16px] text-gray-500 font-opens w-[90%]">As one of the world’s largest accountancy networks, elixir helps a diverse range of clients with a diverse range of needs.This is especially true of our Advisory Practice, which provides corporate finance and transaction services, business restructuring.</p>
                        <span className="text-[16px] font-opens text-center lg:text-start">Learn More</span>
                    </div>
                </div>
                <div className="flex flex-col lg:flex-row-reverse lg:items-center gap-12">
                    ...
                    <div className="flex flex-col text-center sm:text-start items-center sm:items-start mx-10 mb-5 gap-6 lg:w-[380px]">
                        ...
                        <p className="text-[16px] text-gray-500 font-opens w-[90%]">Elixir serves clients across the country and around the world as they navigate an increasingly complex tax landscape. Our tax professionals draw on deep experience and industry-specific knowledge to deliver clients the insights and innovation they need.</p>
                        <span className="text-[16px] font-opens text-center lg:text-start">Learn More</span>
                    </div>
                </div>
                <div className="flex flex-col lg:flex-row lg:items-center gap-12">
                    ...
                    <div className="flex flex-col text-center sm:text-start items-center sm:items-start mx-10 mb-5 gap-6 lg:w-[380px]">
                        ...
                        <p className="text-[16px] text-gray-500 font-opens w-[90%]">To help you understand what this road looks like, we surveyed 1165 digital marketers across Europe and North America to explore current trends and priorities in digital marketing.</p>
                        <span className="text-[16px] font-opens text-center lg:text-start">Learn More</span>
                    </div>
                </div>
            </div>
