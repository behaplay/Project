export const Information2 = () => {
    return (
        <section className="m-auto flex flex-row gap-24 sm:justify-center flex-wrap md:mt-14 ml-2">
                <div className="flex flex-col">
                    ...
                    <p className="text-[16px] text-gray-500 w-[80%] sm:w-[262px]">Before talking destination, we shine a spotlight across your organization
                ...
                <div className="flex flex-col">
                    ...
                    <p className="text-[16px] text-gray-500 w-[80%] sm:w-[288px]">If you face any trouble, you can always let our dedicated support team help you. They are ready for you 24/7.</p>
                </div>
                <div className="flex flex-col">
                    <div className="flex flex-row items-center gap-2">
                    ...
                    <p className="text-[16px] text-gray-500 w-[80%] sm:w-[288px]">We develop a systematic well-ordered process of analysis, from concept through implementation.</p>
                </div>
        </section>
    )
}
